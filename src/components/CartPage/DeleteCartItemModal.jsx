...
function DeleteCartItemModal({ showCartDelete, handleClose, handleMoveToWishlist, handleRemoveCart, selectedItem }) {
    ...
    // Change function name to avoid conflict with prop
    const handleMoveToWishlistClick = async () => {
        ...
        // Call the prop function with selectedItem
        await handleMoveToWishlist(selectedItem);
    }
    
    const handleRemoveClick = () => {
        // Call the prop function with selectedItem
        handleRemoveCart(selectedItem);
    }
                ...
                <Offcanvas show={showCartDelete} onHide={handleClose} placement="end" className="del-body">
                    ...
                    <Offcanvas.Body>
                        ...
                        <div className='deletecart-button-container'>
                            <button className="deletecart-button" onClick={handleRemoveClick}>
                                Remove From Cart
                            </button>
                            <button className="deletecart-button" onClick={handleMoveToWishlistClick}>
                                Move To Wishlist
                            </button>
                        </div>
                    </Offcanvas.Body>
