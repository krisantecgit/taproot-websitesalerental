...
function FeedbackCarousel({ data }) {
    // const banners = [
    ...
    const totalGroups = Math.ceil(data.length / visibleSlides);
        ...
        <div className="fb-container">
            ...
            {/* <div className="fb-carousel-wrapper">
                ...
                <div
                    ...
                    style={{
                        ...
                        width: `${(data.length / visibleSlides) * 100}%`,
                    }}
                >
                    {data.map((img, index) => (
                        <div
                        ...
                        >
                            <img src={img.image__image} alt={`feedback-${index}`} className="fb-image" />
                        </div>
                    ))}
                </div>
            ...
            <div className="fb-carousel-wrapper">
                ...
                <div
                    className="fb-slider"
                    style={{
                        transform: `translateX(-${current * 370}px)`, // 340px + 30px gap
                    }}
                >
                    {data.map((img, index) => (
                        <div className="fb-slide" key={index}>
                            <img
                                src={img.image__image}
                                alt={`feedback-${index}`}
                                className="fb-image"
                            />
                        </div>
